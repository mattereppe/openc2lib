            ...
            if 'response_requested' in msg.content.args.keys():
                match msg.content.args['response_requested']:
                    ...
                    case ResponseType.ack:
                        response_content = Response(status=StatusCode.PROCESSING,
                                                    status_text=StatusCodeDescription[StatusCode.PROCESSING])
                    ...
                    case _:
                        response_content = Response(status=StatusCode.BADREQUEST,
                                                    status_text="Invalid response requested")
